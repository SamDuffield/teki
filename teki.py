...
class TemperedEKI(TransportSampler):
    ...
    def __init__(self,
        ...
        self.parameters.term_max_sd = term_max_sd
    ...
    def startup(self,
        ...
        initial_extra.lik_prec_sqrt = jnp.eye(initial_state.simulated_data.shape[-1])
    ...
    def termination_criterion(self,
        ...
        return jnp.any(jnp.array([ensemble_state.temperature >= self.max_temperature,
                                  ...
                                  jnp.std(ensemble_state.value, axis=0, ddof=1).max() < extra.parameters.term_max_sd,
    ...
    def update(self,
        ...
        extra.lik_prec_sqrt = jnp.linalg.inv(cov_y_given_x_chol + self.parameters.nugget * jnp.eye(d_y))
...
class AdaptiveTemperedEKI(TemperedEKI):
    ...
    def __init__(self,
        ...
        super().__init__(temperature_schedule=None,
                         ...
                         nugget=nugget, term_max_sd=term_max_sd, **kwargs)
    ...
    def next_temperature(self,
        ...
        pseudo_likelihood_potential = gaussian_potential(ensemble_state.simulated_data,
                                                         extra.data, sqrt_prec=extra.lik_prec_sqrt,
                                                         det_prec=1.)
